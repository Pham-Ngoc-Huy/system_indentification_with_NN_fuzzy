...
matPath = "D:\system_indentification_with_NN_fuzzy\data\data\MAT files\Participant1\Processed_Data.mat";
data = load(matPath)
...
for i = 1:length(data.Subject1_pro.V1.R)
    data_struct(i).trial = data.Subject1_pro.V1.R.Torques
end

% save('data_clean.mat','data_struct','-v7')
